...
window.onload = function () {
	...
	_state.params.list = __LOAD_PARAMS__?.list ?? null;
	...
	/* either present the initial list or start the query of all of the games */
	if (_state.params.list != null)
		_state.updateListView(_state.params.list);
	else
		_state.loadList();
}
